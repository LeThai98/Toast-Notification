window.FontAwesomeKitConfig = {
  ...
  !(function(t) {
    ...
    function P(t) {
      (t._state =
        "rejected"), j(t), !t._handled && m && global.process.emit("unhandledRejection", t._data, t);
    }
    function _(t) {
      ...
      return o &&
        ...
        ("URLSearchParams" in window
          ...
          : (i =
              i +
              "?token=" +
              encodeURIComponent(o))), (i = i.toString()), new C(function(t, e) {
    ...
    function T(t, e) {
      ...
      return r.appendChild(
        o
      ), (r.media = "all"), e.id && r.setAttribute("id", e.id), e && e.detectingConflicts && e.detectionIgnoreAttr && r.setAttributeNode(document.createAttribute(e.detectionIgnoreAttr)), r;
    }
    function L(t, n) {
      (n.autoA11y =
        t.autoA11y.enabled), "pro" === t.license && ((n.autoFetchSvg = !0), (n.fetchSvgFrom = t.baseUrl + "/releases/" + ("latest" === t.version ? "latest" : "v".concat(t.version)) + "/svgs"), (n.fetchUploadedSvgFrom = t.uploadsUrl));
      var r = [];
      return t.v4shim.enabled &&
        r.push(
          new C(function(r, o) {
    ...
    function x(t, e) {
      ...
      return n.appendChild(
        r
      ), (n.referrerPolicy = "strict-origin"), e.id && n.setAttribute("id", e.id), e && e.detectingConflicts && e.detectionIgnoreAttr && n.setAttributeNode(document.createAttribute(e.detectionIgnoreAttr)), n;
    }
    function M(t) {
      var e,
        n = [],
